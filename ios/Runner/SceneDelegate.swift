...
class SceneDelegate:UIResponder,UIWindowSceneDelegate {
            ...
            window?.makeKeyAndVisible()
                ...
                if connectionOptions.urlContexts.first?.url != nil {
                         let urlinfo = connectionOptions.urlContexts.first?.url
                           ...
                           self.handle(urlString: urlinfo?.absoluteString ?? "")
    ...
    private func handle(urlString : String) {
        eventChannel?.setStreamHandler(linkStreamHandler)
        linkStreamHandler.handleLink(urlString)
    }
    ...
    func scene(_ scene: UIScene, continue userActivity: NSUserActivity) {
        ...
        handle(urlString: userActivity.webpageURL?.absoluteString ?? "")
